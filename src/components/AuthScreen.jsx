...
export default function AuthScreen() {
  ...
  const inputClass = "w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2"

  return (
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: 'var(--t-page)' }}>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div>
            ...
            <input
              ...
              style={{ '--tw-ring-color': 'var(--t-ring)' }}
            />
          </div>
          <div>
          ...
          {message && (
            <div className="bg-green-50 border border-green-200 rounded-lg px-3 py-2 text-sm text-green-700">{message}</div>
          )}
